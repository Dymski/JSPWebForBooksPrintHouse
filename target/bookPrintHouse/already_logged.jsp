...
<div class="container" style="text-align: center">
    ...
    <br/>
    <h2><%
        out.print("You are already logged as "+ session.getAttribute("email"));
    %></h2>
    <h3>You can <a href="place_order">place new order </a>or</h3>
    <h4>view your <a href="account">account</a></h4>
    <h4>or <a href="log_out">log out </a> if you wish to.</h4>
    <br/>
    <hr class="featurette-divider">
