...
<nav class="site-header sticky-top py-1">
    <div class="container d-flex flex-column flex-md-row justify-content-between">
        <a class="py-2 d-none d-md-inline-block" href="#">Our product</a>
        <a class="py-2 d-none d-md-inline-block" href="#">Place order</a>
        <a class="py-2 d-none d-md-inline-block" href="#">Create account</a>
